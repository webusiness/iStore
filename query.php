...
function add_producto($producto){
	for ($i = 0 ; $i < count($producto); $i++) {
		...
		$consulta = "INSERT INTO wp_posts VALUES (NULL, '1', NOW(), NOW(), '".$producto[$i]["producto_desc"]."', '".$producto[$i]["producto_nombre"]."', '".$producto[$i]["producto_desc_corta"]."', 'private', 'open', 'closed', '', '".$nom_producto."', '', '', NOW(), NOW(), '', '0', '".$Guid."', '0', 'product', '', '0')";
